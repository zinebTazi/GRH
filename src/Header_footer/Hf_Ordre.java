...
public class Hf_Ordre extends PdfPageEventHelper {
    ...
    public void onEndPage(PdfWriter writer, Document document) {
        ...
        try {
            ...
            table1.setLockedWidth(true);
            table1.setWidthPercentage(100);
            Paragraph b = new Paragraph("NB: les charges de déplacement sont à la charge de l'interessé.");
            cell = new PdfPCell(new Paragraph(b));
            cell.setRunDirection(PdfWriter.RUN_DIRECTION_LTR);
            cell.setBorder(Rectangle.NO_BORDER);
            table1.addCell(cell);
            table1.writeSelectedRows(0, -1, document.leftMargin(),
                    document.bottom() + 20, writer.getDirectContent());
            Paragraph a = new Paragraph();
